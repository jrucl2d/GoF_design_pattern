package com.example.guru.creational.prototype;

import com.example.guru.creational.prototype.cache.BundledShapeCache;
import com.example.guru.creational.prototype.shapes.Circle;
import com.example.guru.creational.prototype.shapes.Rectangle;
import com.example.guru.creational.prototype.shapes.Shape;
    ...
    private static void cloneAndCompare(List<Shape> shapes, List<Shape> shapesCopy) {
        ...
        for (int i = 0; i < shapes.size(); i++) {
            if (shapes.get(i) != shapesCopy.get(i)) {
                System.out.println(i + ": Shapes are different object");
